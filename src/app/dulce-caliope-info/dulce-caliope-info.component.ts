...
export class DulceCaliopeInfoComponent implements OnInit {
  ...
  items: ItemInfo[] =[
    ...
    },
    {
      ...
      conclusion: "¿Que llevar en el bolso? Para el/la bebé: 👶 -3/4 mudas de ropa compuestas por: body, ranita/pantalón, batita o camperita, medias y gorro. Se recomienda que la ropita sea de algodón y preferentemente de colores claros (las prendas muy coloridas son hermosas, pero para teñirlas se utilizan muchos productos químicos que pueden dañar la piel de tu bebé, yo elegí para el primer día un ajuar completamente blanco!) Lavadas! (En el próximo post de info vamos a hablar sobre el lavado de la ropita -Manta recibidor -Manta de abrigo -20 pañales apro -Óleo y algodón NO sé recomiendan guantes o mitones! 🧤 Los bebés perciben a través de las manos y la boca, colocando estos elementos obstaculizamos su desarrollo y sus mecanismos de autorregulación. Si tenés miedo de que tu bebé tenga las uñitas largas y pueda lastimarse guarda en el bolso una lima fina o tijerita. Los gorritos son muy importantes durante el primer mes de vida, lxs bebés no regulan correctamente su temperatura corporal, y como su cabecita es tan grande es por dónde más pierden calor. Si querés amamantar no se recomienda llevar sucedáneos (mamadera/chupete)🍼 generan confusión de succión, dificultando la lactancia. Para mamá: -Camisón cómodo que favorezca la lactancia si así lo desean, lo mismo los corpiños. -Varios cambios de bombacha (al menos 4) -Apósitos post parto (mínimo 10) -Toallón y elementos de higiene -Colita para el pelo"
    },
    {
